...
import (
	...
	authhand "user-service/internal/http/auth"
	"user-service/internal/http/middleware"
	profilehand "user-service/internal/http/profile"
	rabbitmqconsumer "user-service/internal/rabbitmq"
	authsvc "user-service/internal/service/auth"
	profilesvc "user-service/internal/service/profile"
	postgresstorage "user-service/internal/storage/postgres"
	rediscache "user-service/internal/storage/redis"
)
